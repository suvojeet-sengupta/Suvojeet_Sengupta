...
const SocialLinks = () => {
  ...
  return (
    ...
    >
      {/* Instagram */}
      <motion.a
        href="https://www.instagram.com/suvojeet__sengupta?igsh=MWhyMXE4YzhxaDVvNg=="
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-300 hover:opacity-80 transition-opacity duration-300"
      ...
      {/* YouTube */}
      <motion.a
        href="https://youtube.com/@suvojeetsengupta?si=xmXfnPFgxoYOzuzq"
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-300 hover:opacity-80 transition-opacity duration-300"
        variants={socialIconVariants}
