...
const SocialLinks = () => {
  return (
    <div className="flex justify-center space-x-6">
      {/* Instagram */}
      <a href="https://www.instagram.com/suvojeet__sengupta?igsh=MWhyMXE4YzhxaDVvNg==" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transform hover:scale-110 transition-all duration-300">
      ...
      {/* Facebook */}
      <a href="https://www.facebook.com/suvojeetsengupta21" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transform hover:scale-110 transition-all duration-300">
        <svg className="w-9 h-9" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
