...
import * as route0 from '../../../api-handlers/admin/comments/[id]/replies';
import * as route1 from '../../../api-handlers/admin/comments/[id]';
import * as route2 from '../../../api-handlers/admin/comments/bulk';
import * as route3 from '../../../api-handlers/admin/login';
import * as route4 from '../../../api-handlers/admin/logout';
import * as route5 from '../../../api-handlers/admin/messages/[id]';
import * as route6 from '../../../api-handlers/admin/music-videos/[id]';
import * as route7 from '../../../api-handlers/admin/music-videos';
import * as route8 from '../../../api-handlers/admin/overview';
import * as route9 from '../../../api-handlers/admin/posts/[id]';
import * as route10 from '../../../api-handlers/admin/posts';
import * as route11 from '../../../api-handlers/admin/replies/[id]';
import * as route12 from '../../../api-handlers/admin/session';
import * as route13 from '../../../api-handlers/admin/settings';
import * as route14 from '../../../api-handlers/admin/users';
import * as route15 from '../../../api-handlers/public/comments/[commentId]/replies';
import * as route16 from '../../../api-handlers/public/contact';
import * as route17 from '../../../api-handlers/public/music-videos/[id]/play';
import * as route18 from '../../../api-handlers/public/music-videos';
import * as route19 from '../../../api-handlers/public/posts/[slug]/comments';
import * as route20 from '../../../api-handlers/public/posts/[slug]/like';
import * as route21 from '../../../api-handlers/public/posts/[slug]';
import * as route22 from '../../../api-handlers/public/posts';
import * as route23 from '../../../api-handlers/public/subscribe';
