    ...
    const response = new ImageResponse(
      el("div", {
        style: {
          ...
          background: "#0a0a0a", padding: "60px 80px 0px", position: "relative",
        ...
        el("div", { style: { display: "flex", alignItems: "center", gap: "12px", position: "relative" } },
          ...
          el("span", { style: { color: "#f97316", fontSize: "19px", fontWeight: 700, letterSpacing: "0.15em" } }, "SUVOJEET SENGUPTA"),
        ),
        ...
        el("div", { style: { flex: 1, display: "flex", alignItems: "center", position: "relative" } },
          el("div", { style: { display: "flex", flexDirection: "column", gap: "18px" } },
            el("div", { style: { color: "white", fontSize: `${titleFontSize}px`, fontWeight: 800, lineHeight: 1.15, maxWidth: "980px", letterSpacing: "-0.025em" } }, title),
            subtitle
              ? el("div", { style: { color: "#aaaaaa", fontSize: "26px", fontWeight: 400, letterSpacing: "0.02em", maxWidth: "980px" } }, subtitle)
              : null,
          ),
        ),
        // Footer
        el("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: "28px", position: "relative" } },
          el("div", { style: { display: "flex", alignItems: "center", gap: "10px" } },
            ...
            el("span", { style: { color: "#888", fontSize: "20px", fontWeight: 400 } }, "suvojeetsengupta.in"),
          ),
